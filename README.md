# Apache-Kafka
### What Is Kafka?
It is generally used as a publish/subscribe messaging system, It allows us to publish and subscribe to a stream of records that can be categorized. Kafka is written in Java. It is often used in real-time streaming data architectures to provide real-time analytics.<p> Since Kafka is a fast, scalable, durable, [storage](https://github.com/kambiz1363/Apache-Kafka/blob/master/README.md#kafka-storage-internals) and *fault-tolerant publish-subscribe messaging system*.</p>
### kafka architecture
...
* **details about Stream Processing**: 3a
